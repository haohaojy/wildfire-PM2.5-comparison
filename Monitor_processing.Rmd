...
```{r}
#Import monitor data
airsis<-read.csv('/Users/jiayuanhao/Documents/harvard/Rachel/data/comparision/airsis.csv')
airsis$group<-'airsis'
wrcc<-read.csv('/Users/jiayuanhao/Documents/harvard/Rachel/data/comparision/wrcc.csv')
wrcc$group<-'wrcc'
