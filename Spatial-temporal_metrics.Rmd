...
nrow(DvR_apply(Year, 0)) # 56
nrow(DvR_apply(State, 0)) # 30
nrow(DvR_apply(Season, 0)) # 34
...
(56 + 30 + 34) / (324 + 354 + 144) # 0.146

## Check percentages using a tolerance of 5%:
nrow(DvR_apply(Year, 0.05)) # 50
nrow(DvR_apply(State, 0.05)) # 26
nrow(DvR_apply(Season, 0.05)) # 18

50/324 # 0.154
26/354 # 0.073
18/144 # 0.125

(50 + 26 + 18) / (324 + 354 + 144) # 0.114
