...
plot_3_combos<- function(df, col_var, shape_var){
  ...
  if(col_var == "Season"){
    ...
    geom_point()+geom_abline(intercept=0,slope=1)+ 
      ...
      geom_abline(intercept = 0,slope = lm(PM_Di ~ PM2.5 - 1, df)$coefficients, col = "#009E73") +
      geom_text(x=850, y=135, label="Best fit", col = "#009E73") + 
    ...
    geom_point()+ geom_abline(intercept=0,slope=1)+
      ...
      geom_abline(intercept = 0,slope = lm(PM_Reid ~ PM2.5 - 1, df)$coefficients, col = "#009E73") +
      geom_text(x=850, y=175, label="Best fit", col = "#009E73") +
    ...
    geom_point()+ geom_abline(intercept=0,slope=1)+
      ...
      geom_abline(intercept = 0,slope = lm(PM_Di ~ PM_Reid - 1, df)$coefficients, col = "#009E73") +
      geom_text(x=275, y=150, label="Best fit", col = "#009E73") +
